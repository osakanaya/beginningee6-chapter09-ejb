 ...
 * クライアント）から、トランザクション属性がNOT_SUPPORTEDのEJBメソッドを実行した時の
 * トランザクションの振る舞いを確認するテスト。
 *
 */
@RunWith(Arquillian.class)
public class NOT_SUPPORTED_CalleeTest {
	private static final Logger logger = Logger.getLogger(NOT_SUPPORTED_CalleeTest.class
			.getName());
	 ...
	 */
	@Test
	public void testNOT_SUPPORTED_Callee_REQUIRED_Caller_Both_Persist() throws Exception {
		
        ///// テスト /////
		
		required_callerEJB.NOT_SUPPORTED_CalleePersist_REQUIRED_CallerPersist(book, cd);
	...
	/**
	 * ２．NOT_SUPPORTEDの呼び出し先で自力でトランザクション開始→永続化→ロールバックし、
	 * 　　非チェック例外をスローする例
	 * 　　（呼び出し元はその後永続化を行おうとする）
	 * 
	 * 【結果】
	 ...
	 */
	@Test
	public void testNOT_SUPPORTED_Callee_Rollback_REQUIRED_Caller_Persist() throws Exception {
		
        ///// テスト /////
		
		required_callerEJB.NOT_SUPPORTED_CalleePersistAndRollback_REQUIRED_CallerPersist(book, cd);
	 ...
	 */
	@Test
	public void testNOT_SUPPORTED_Callee_Persist_REQUIRED_Caller_PersistAndRollback() throws Exception {
		
        ///// テスト /////
		
		required_callerEJB.NOT_SUPPORTED_CalleePersist_REQUIRED_CallerPersistAndRollback(book, cd);
	 ...
	 */
	@Test
	public void testNOT_SUPPORTED_Callee_SUPPORTS_Caller_Both_Persist() throws Exception {
		
        ///// テスト /////
		
		supports_callerEJB.NOT_SUPPORTED_CalleePersist_SUPPORTS_CallerPersist(book, cd);
	 ...
	 */
	@Test
	public void testNOT_SUPPORTED_Callee_Rollback_SUPPORTS_Caller_Persist() throws Exception {
		
        ///// テスト /////
		
		supports_callerEJB.NOT_SUPPORTED_CalleePersistAndRollback_SUPPORTS_CallerPersist(book, cd);
	 ...
	 */
	@Test
	public void testNOT_SUPPORTED_Callee_Persist_SUPPORTS_Caller_PersistAndRollback() throws Exception {
		
        ///// テスト /////
		
		supports_callerEJB.NOT_SUPPORTED_CalleePersist_SUPPORTS_CallerPersistAndRollback(book, cd);
