 ...
 * クライアント）から、トランザクション属性がREQUIREDのEJBメソッドを実行した時の
 * トランザクションの振る舞いを確認するテスト。
 *
 */
@RunWith(Arquillian.class)
public class REQUIRED_CalleeTest {
	private static final Logger logger = Logger.getLogger(REQUIRED_CalleeTest.class
			.getName());
	 ...
	 */
	@Test
	public void testREQUIRED_Callee_REQUIRED_Caller_Both_Persist() throws Exception {
		
        ///// テスト /////
		
		required_callerEJB.REQUIRED_CalleePersist_REQUIRED_CallerPersist(book, cd);
	 ...
	 */
	@Test
	public void testREQUIRED_Callee_ThrowException_REQUIRED_Caller_Persist() throws Exception {
		
        ///// テスト /////
		
		try {
			required_callerEJB.REQUIRED_CalleePersistAndRollback_REQUIRED_CallerPersist(book, cd);
			fail("Should throw exception");
		} catch (Exception e) {
			// Book02エンティティの永続化でTransactionRequiredExceptionをcauseとする
			// 例外がスローされることを確認
	 ...
	 */
	@Test
	public void testREQUIRED_Callee_Persist_REQUIRED_Caller_PersistAndThrowException() throws Exception {
		
        ///// テスト /////
		
		required_callerEJB.REQUIRED_CalleePersist_REQUIRED_CallerPersistAndRollback(book, cd);
	 ...
	 */
	@Test
	public void testREQUIRED_Callee_SUPPORTS_Caller_Both_Persist() throws Exception {
		
        ///// テスト /////
		
		supports_callerEJB.REQUIRED_CalleePersist_SUPPORTS_CallerPersist(book, cd);
	 ...
	 */
	@Test
	public void testREQUIRED_Callee_ThrowException_SUPPORTS_Caller_Persist() throws Exception {
		
        ///// テスト /////
		
		supports_callerEJB.REQUIRED_CalleePersistAndRollback_SUPPORTS_CallerPersist(book, cd);
	 ...
	 */
	@Test
	public void testREQUIRED_Callee_Persist_SUPPORTS_Caller_PersistAndRollback() throws Exception {
		
        ///// テスト /////
		
		supports_callerEJB.REQUIRED_CalleePersist_SUPPORTS_CallerPersistAndRollback(book, cd);
